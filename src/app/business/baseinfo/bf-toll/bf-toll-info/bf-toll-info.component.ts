...
@Component({
  selector: 'rbi-bf-toll-info',
  templateUrl: './bf-toll-info.component.html',
  styleUrls: ['./bf-toll-info.component.less']
})
export class BfTollInfoComponent implements OnInit {
  ...
  // 修改申请
  public tollApplacationDialog: boolean;
  ...
  public keyRoomInfoList = [false, false, false, false, false, false];
  ...
  public tollAddSureClick(): void {
    const list  = ['chargeName', 'chargeType', 'chargeUnit', 'refund', 'mustPay'];
