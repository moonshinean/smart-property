...
import { BfRoombindChangeitemRoutingModule } from './bf-roombind-changeitem-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    BfRoombindChangeitemRoutingModule,
    InputTextModule,
    TableModule,
    ScrollPanelModule,
    DialogModule,
...
export class BfRoombindChangeitemModule { }
